...
class SYSTEMD_QT_EXPORT Unit : public QObject
{
    ...
    Q_PROPERTY(bool canIsolate READ canIsolate CONSTANT)

    Q_PROPERTY(bool canReload READ canReload CONSTANT)

    Q_PROPERTY(bool canStart READ canStart CONSTANT)

    Q_PROPERTY(bool canStop READ canStop CONSTANT)

    Q_PROPERTY(QString description READ description CONSTANT)

    Q_PROPERTY(QString fragmentPath READ fragmentPath CONSTANT)

    Q_PROPERTY(QString loadState READ loadState CONSTANT)

    Q_PROPERTY(QStringList names READ names CONSTANT)

    Q_PROPERTY(QString subState READ subState NOTIFY subStateChanged)

    Q_PROPERTY(QString unitFileState READ unitFileState CONSTANT)
  ...
  public:
    ...
    /**
     * All names of the unit, including the primary name that is also exposed in
     * Id
     *
